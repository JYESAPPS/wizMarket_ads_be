...
from app.schemas.ads import (
    ...
    KaKaoTempInsert, KaKaoTempGet, AdsTemplateSeedImage, PopupUpdate, RePopupUpdate
)
...
from app.service.ads import (
    ...
    update_re_popup as service_update_re_popup,
)
...
from app.service.ads_login import (
    ...
    select_business_name as service_select_business_name,
)
...
def select_ads_init_info(store_business_number: str):
    ...
    try:
        ...
        login_provider, popup, re_popup = service_select_login_provider(user_id)
...
@router.post("/re_popup")
def update_user_re_popup(payload: RePopupUpdate):
    service_update_re_popup(payload.user_id, payload.re_popup)
    return {"result": "success"}
